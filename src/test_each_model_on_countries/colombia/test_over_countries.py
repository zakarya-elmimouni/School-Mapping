...
"""This scripts is used to evaluate the model trained on colombia over the other countries"""

# =====================
# CONFIGURATION
# =====================
MODEL_PATH = "path to the colombia model that you want to evaluate over the other countries"
COUNTRIES = ["brazil", "togo", "nigeria", "mali", "peru", "bangladesh", "lesotho"]
NUM_IMAGES = 10
...
for country in COUNTRIES:
    ...
    output_dir = f"results/colombia/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_{country}" # change the saving directory as needed
    ...
    with open(output_metrics, "w") as f:
        f.write("=== YOLOv10 trained on Colombia and evaluated on golden test set ===\n")
