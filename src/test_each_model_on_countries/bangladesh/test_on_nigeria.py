...
""" this script evaluates the finetuned bangaldesh model on the golden test set of nigeria dataset."""
...
IMAGES_TEST_DIR = "dataset/nigria/manual_labeled_data/images/test"
LABELS_TEST_DIR = "dataset/nigeria/manual_labeled_data/labels/test"
OUTPUT_METRICS_TXT = "results/bangladesh/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_nigeria/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/bangladesh/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_nigeria/yolo_predictions"
