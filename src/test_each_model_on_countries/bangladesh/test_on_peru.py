...
""" this script evaluates the finetuned bangaldesh model on the golden test set of peru dataset."""
...
OUTPUT_METRICS_TXT = "results/bangladesh/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_peru/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/bangladesh/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_peru/yolo_predictions"
