...
# CONFIGURATION
# =====================
MODEL_PATH = "results/africa_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria/best/weights/best.pt"
COUNTRIES = ["brazil", "peru", "nigeria", "togo", "colombia", "bangladesh", "mali","lesotho"]
NUM_IMAGES = 10
...
for country in COUNTRIES:
    ...
    output_dir = f"results/africa_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria/best/outputs_over_{country}"
    ...
    with open(output_metrics, "w") as f:
        f.write(f"=== YOLOv10 trained on africa global dataset and evaluated on golden test set of {country} ===\n")
