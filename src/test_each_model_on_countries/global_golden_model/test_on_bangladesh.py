...
""" this script evaluates the finetuned global model, on the golden test set of bangaldesh dataset."""

MODEL_PATH = "results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil/best/weights/best.pt"
...
OUTPUT_METRICS_TXT = "results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil/best/outputs_over_bangladesh/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil/best/outputs_over_bangladesh/yolo_predictions"
