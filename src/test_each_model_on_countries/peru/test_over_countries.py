...
"""This scripts is used to evaluate the model trained on peru over the other countries"""

# =====================
# CONFIGURATION
# =====================
MODEL_PATH = "path to the peru model that you want to evaluate over the other countries"
COUNTRIES = ["brazil", "togo", "nigeria", "mali", "colombia", "bangladesh", "lesotho"]
NUM_IMAGES = 10
...
for country in COUNTRIES:
    ...
    output_dir = f"results/peru/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_{country}" # change the saving directory as neeeded
    ...
    with open(output_metrics, "w") as f:
        f.write("=== YOLOv10 trained on Peru and evaluated on golden test set ===\n")
