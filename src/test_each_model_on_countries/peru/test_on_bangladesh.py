...
""" this script evaluates the finetuned peru's model, on the golden test set of bangaldesh dataset."""
...
OUTPUT_METRICS_TXT = "results/peru/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_bangladesh/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/peru/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_bangladesh/yolo_predictions"
