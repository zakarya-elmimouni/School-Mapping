...
class YOLOObjective:
    def __init__(self, log_path="results/global_golden/ecp_yolo10n_finetuning_nigeria_based_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria" # change as needed ( saving directory)

        try:
            model = YOLO("results/nigeria/rslt_yolo10n_finetune_auto_on_golden/exp/weights/best.pt") # existing pretrained model on auto_labeled_data (change as needed)
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria",# saving directory (change as needed)
                name=exp_name,
            )
