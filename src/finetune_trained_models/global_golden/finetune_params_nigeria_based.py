...
class YOLOObjective:
    def __init__(self, log_path="results/global_golden/ecp_yolo10n_finetuning_nigeria_based_log.csv"):
    ...
    def __call__(self, x):
        ...
        save_dir="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria"
        ...
        try:
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria",
                name=exp_name,
            )
