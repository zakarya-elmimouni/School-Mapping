...
class YOLOObjective:
    def __init__(self, log_path="results/global_golden/ecp_yolo10n_finetuning_brazil_based_log.csv"):# change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil" # saving directory # change as needed

        try:
            model = YOLO("results/brazil/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/weights/best.pt")# existing pretrained model on auto_labeled_data (change as needed)
            ...
            results = model.train(
                ...
                save_period=40,
                verbose=False,
                project="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil",# saving directory (change as needed) 
                name=exp_name,
            )
