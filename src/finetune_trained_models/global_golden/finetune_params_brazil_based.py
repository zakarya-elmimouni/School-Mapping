...
class YOLOObjective:
    def __init__(self, log_path="results/global_golden/ecp_yolo10n_finetuning_brazil_based_log.csv"):
    ...
    def __call__(self, x):
        ...
        save_dir="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil"

        try:
            model = YOLO("results/brazil/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/weights/best.pt")
            ...
            results = model.train(
                ...
                save_period=40,
                verbose=False,
                project="results/global_golden/rslt_yolo10n_finetuning_params_finetuned_brazil",
                name=exp_name,
            )
