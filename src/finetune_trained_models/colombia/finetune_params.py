...
DATA_YAML = 'dataset/colombia/manual_labeled_data/data.yaml' ## change as needed
...
class YOLOObjective:
    def __init__(self, log_path="results/colombia/ecp_yolo10n_finetuning_params_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/colombia/rslt_yolo10n_finetuning_auto_on_golden_best_params" # change as needed (saving directory)

        try:
            model = YOLO("results/colombia/rslt_yolo10n_auto_labeling/exp/weights/best.pt")## existing pretrained model on auto_labeled_data (change as needed)
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/colombia/rslt_yolo10n_finetuning_auto_on_golden_best_params",# change as needed (saving directory)
                name=exp_name,
            )
