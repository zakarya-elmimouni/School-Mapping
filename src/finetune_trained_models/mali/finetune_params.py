...
class YOLOObjective:
    def __init__(self, log_path="results/mali/ecp_yolo10n_log.csv"):
    ...
    def __call__(self, x):
        ...
        save_dir="results/mali/rslt_yolo10n_finetuning_auto_on_golden_best_params"

        try:
            model = YOLO("results/mali/rslt_yolo10n_auto_labeling/exp/weights/best.pt")
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/mali/rslt_yolo10n_finetuning_auto_on_golden_best_params",
                name=exp_name,
            )
