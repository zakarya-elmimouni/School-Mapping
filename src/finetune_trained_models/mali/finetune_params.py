...
DATA_YAML = 'dataset/mali/manual_labeled_data/data.yaml' # change as needed
...
class YOLOObjective:
    def __init__(self, log_path="results/mali/ecp_yolo10n_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/mali/rslt_yolo10n_finetuning_auto_on_golden_best_params" # path to saving directory ( change as needed)

        try:
            model = YOLO("results/mali/rslt_yolo10n_auto_labeling/exp/weights/best.pt") # existing model pretrained on auto_labeled_data
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/mali/rslt_yolo10n_finetuning_auto_on_golden_best_params", # path to saving directory ( change as needed)
                name=exp_name,
            )
