...
for country in COUNTRIES:
    ...
    output_dir = f"results/togo/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs_over_{country}"
    ...
    with open(output_metrics, "w") as f:
        f.write("=== YOLOv10 trained on Togo and evaluated on golden test set ===\n")
