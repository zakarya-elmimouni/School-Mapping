...
DATA_YAML = 'dataset/big_global_golden_dataset/data.yaml'# change as needed
...
class YOLOObjective:
    def __init__(self, log_path="results/big_global_golden/ecp_yolo10n_finetuning_nigeria_based_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/big_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria" # saving directory (change as needed)

        try:
            model = YOLO("results/nigeria/rslt_yolo10n_finetune_auto_on_golden/exp/weights/best.pt") # existing pretrained model (change as needed)
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/big_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria",# change as needed ( saving directory)
                name=exp_name,
            )
