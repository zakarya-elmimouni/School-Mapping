...
DATA_YAML = 'dataset/lesotho/manual_labeled_data/data.yaml' # change as needed
...
class YOLOObjective:
    def __init__(self, log_path="results/lesotho/ecp_yolo10n_log.csv"): # change as needed
    ...
    def __call__(self, x):
        ...
        save_dir="results/lesotho/rslt_yolo10n_finetuning_auto_on_golden_best_params" # path to saving directory( change as needed)

        try:
            model = YOLO("results/lesotho/rslt_yolo10n_auto_labeling/exp/weights/best.pt") # exisiting model pretrained on auto_labeled data
            ...
            results = model.train(
                ...
                save_period=20,
                verbose=False,
                project="results/lesotho/rslt_yolo10n_finetuning_auto_on_golden_best_params", # path to saving directory( change as needed)
                name=exp_name,
            )
