...
MODEL_PATH = "results/big_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria/try4/weights/best.pt"
DATA_YAML = "dataset/big_global_golden_dataset/data.yaml"

OUTPUT_METRICS_TXT = "results/big_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria/try4/outputs/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/big_global_golden/rslt_yolo10n_finetuning_params_finetuned_nigeria/try4/outputs/yolo_predictions"
