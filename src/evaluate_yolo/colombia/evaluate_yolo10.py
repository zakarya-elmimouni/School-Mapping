...
OUTPUT_METRICS_TXT = "results/colombia/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs/evaluation_metrics.txt"
OUTPUT_IMG_DIR = "results/colombia/rslt_yolo10n_finetuning_auto_on_golden_best_params/best/outputs/yolo_predictions"
