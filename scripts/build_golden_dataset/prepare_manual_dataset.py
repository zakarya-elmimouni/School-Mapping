...
# ---------- CONFIGURATION ---------------------------------------------------
LABEL_SRC_DIR     = Path("save_direction/new_ones")                       # existing .txt labels
POS_IMAGE_SRC_DIR = Path("data/brazil/satellite/school")         # positive images
#NEG_IMAGE_SRC_DIR = Path("data/brazil/satellite/non_school")     # negative images

DEST_BASE_DIR     = Path("dataset/brazil/fixed_bb_and_manual_data/manual_labeled_data2")
...
#def copy_negative_images(limit: int = 60) -> int:
