...
# ---------- CONFIGURATION ---------------------------------------------------
LABEL_SRC_DIR     = Path("dataset/mali/manual_labeled_images")                       # existing .txt labels
POS_IMAGE_SRC_DIR = Path("data/mali/satellite/school")         # positive images
NEG_IMAGE_SRC_DIR = Path("dataset/mali/negative_mali")     # negative images

DEST_BASE_DIR     = Path("dataset/mali/manual_labeled_data")
