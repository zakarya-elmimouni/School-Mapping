...
# ---------- CONFIGURATION ---------------------------------------------------
LABEL_SRC_DIR     = Path("dataset/togo/manual_labeled_images")                       # existing .txt labels
POS_IMAGE_SRC_DIR = Path("data/togo/satellite/school")         # positive images
NEG_IMAGE_SRC_DIR = Path("dataset/togo/negative_togo")     # negative images

DEST_BASE_DIR     = Path("dataset/togo/manual_labeled_data")
