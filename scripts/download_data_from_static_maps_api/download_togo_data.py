...
# ------------ Configuration ------------
API_KEY   = "Api key"
CSV_PATH  = "data/togo/Data_togo_13000_dedup.csv"  # the csv file in data folder contains the coordinates of school and non-school.

BASE_DIR  = "data/togo"
SAT_DIR   = os.path.join(BASE_DIR, "satellite")
LABELS_CSV = "files_togo.csv"  # downloaded labels files
