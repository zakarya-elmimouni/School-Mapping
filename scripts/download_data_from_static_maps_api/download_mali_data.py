...
# ------------ Configuration ------------
API_KEY   = "api key"
CSV_PATH  = "data/mali/Data_mali_13000_dedup.csv"  # the csv file in data folder contains the coordinates of school and non-school.

BASE_DIR  = "data/mali"
SAT_DIR   = os.path.join(BASE_DIR, "satellite")
LABELS_CSV = "files_mali.csv"  # downloaded labels files
