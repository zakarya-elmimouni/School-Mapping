...
CSV_PATH  = "data/brazil/Data_brazil_10334_dedup.csv" # the csv file in data folder contains the coordinates of school and non-school.

BASE_DIR  = "data"
SAT_DIR   = os.path.join(BASE_DIR, "satellite")
LABELS_CSV = "files_brazil.csv" # downloaded files
