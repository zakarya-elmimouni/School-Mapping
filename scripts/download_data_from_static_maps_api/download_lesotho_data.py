...
# ------------ Configuration ------------
API_KEY   = "api key"
CSV_PATH  = "data/lesotho/Data_lesotho_3000_dedup.csv"  # the csv file in data folder contains the coordinates of school and non-school.

BASE_DIR  = "data/lesotho"
SAT_DIR   = os.path.join(BASE_DIR, "satellite")
LABELS_CSV = "files_lesotho.csv"  # downloaded labels files
